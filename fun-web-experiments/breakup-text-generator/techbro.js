...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    function processForm() {
      ...
      message3.innerHTML = "i knew i had to end things during my " + benderTime + "-week-long " + drugName + " bender, when i had the idea for an app where you can order " + orderProduct + " delivered to your door " + subTime + " upon subscription. this venture is going to take a lot of focus, and i cannot be tied down on my " + transport + " to success. ";
