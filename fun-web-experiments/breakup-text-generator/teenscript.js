...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    function processForm() {
      ...
      const cussWord = document.teenForm.cussWord.value;
      ...
      message2.innerHTML = "like uve been wanting to hangout like .. all the time lol .but tbh  im kinda busy with all my " + hobbiesLike + " n stuff. LOL tbh im more interested in " +  objectsLike + " not 2 be rudee or anything wer still gunna b 4th period geometry homiez !!! lmao " + cussWord + teacherName + "amirite!?!?  xO";
      message3.innerHTML = "anyway lol awk! see u at " + girlName + "'s pool party saturday!?";
      message4.innerHTML = myName;
